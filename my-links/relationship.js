...
const links = [
    ...
    // School Friends
    {source: "Mahima", target: "SchoolFriends", type: "School friends"},
    {source: "Meha", target: "SchoolFriends", type: "School friends"},

    // College Friends
    {source: "Gayatri", target: "CollegeFriends", type: "College Friends"},

    // Current Partner
    {source: "Tejas", target: "Current", type: "cp"},

    // Situationhips
    {source: "Raghav", target: "Sship", type: "sship"},
    {source: "Meha", target: "Sship", type: "sship"},

    // EX  
    {source: "Harshad", target: "Ex ", type: "ex"},


    // Immediate Family
    {source: "Madhuri", target: "ImmediateFamily", type: "imf"},
    {source: "Ramakrishna", target: "ImmediateFamily", type: "imf"},
    {source: "Vasist ", target: "ImmediateFamily", type: "imf"},
    {source: "Vasist ", target: "Madhuri", type: "imf"},
    {source: "Vasist ", target: "Ramakrishna", type: "imf"},

    // Distant Family
    {source: "Manisha", target: "DistantFamily", type: "dif"},

    // Apartment Friends
    {source: "Raghav", target: "ApartmentFriends", type: "APT"},
    {source: "Harshad", target: "ApartmentFriends", type: "APT"},
    {source: "Roshini", target: "ApartmentFriends", type: "APT"},
    {source: "Sanghamitra", target: "ApartmentFriends", type: "APT"},
